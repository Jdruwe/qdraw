(function (window, document) {
    ...
    handwriting.Canvas.prototype.touchEnd = function (e) {
        ...
        this.query()
        console.log('a touch event is ending')
    };
    ...
    handwriting.recognize = function (trace, options, callback) {
        ...
        xhr.open("POST", "https://www.google.com.tw/inputtools/request?itc=und-t-i0-handwrit&app=hwtcharpicker");
